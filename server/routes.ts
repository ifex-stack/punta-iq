...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Set up AI prediction routes
  app.use('/api/ai', aiPredictionRouter);
  
  // Set up analytics routes
  app.use('/api/analytics', analyticsRouter);
  
  // Debug login endpoint has been removed for security reasons
  ...
  // Stripe subscription creation endpoint is implemented above at line ~876
